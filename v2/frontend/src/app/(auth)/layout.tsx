      ...
      <MaxWidth>
        <div className="relative z-10 min-h-screen grid gap-10 py-12 lg:grid-cols-[minmax(0,1fr)_360px] lg:items-center">
          <div className="hidden items-center justify-center lg:flex">
            <div className="relative w-full max-w-xl overflow-hidden rounded-2xl border border-border/60 bg-card/70 p-10 shadow-[0_20px_50px_rgba(16,44,50,0.12)] backdrop-blur">
