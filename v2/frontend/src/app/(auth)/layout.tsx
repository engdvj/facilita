...
export default function AuthLayout({ children }: { children: ReactNode }) {
  return (
    <div className="motion-page relative min-h-screen overflow-hidden text-foreground">
      ...
      <MaxWidth>
        <div className="relative z-10 min-h-screen grid gap-12 py-14 lg:grid-cols-[minmax(0,1fr)_420px] lg:items-center lg:gap-16 xl:grid-cols-[minmax(0,1fr)_480px]">
          ...
          <div className="flex items-center justify-center px-6 py-12 lg:px-0 lg:justify-end">
            <div className="relative w-full min-w-[300px] max-w-[440px] overflow-hidden rounded-[24px] border border-border/70 bg-card/90 p-10 shadow-[0_26px_60px_rgba(16,44,50,0.16)] backdrop-blur-sm animate-in fade-in slide-in-from-bottom-4 dark:border-white/10 dark:bg-card/80 dark:shadow-[0_32px_70px_rgba(0,0,0,0.6)] sm:p-12">
